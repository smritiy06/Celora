...
export const mockCurrentUser: User = {
  ...
  achievements: [
    { id: "ach-1", title: "First Steps", description: "Complete your first course", icon: "🎓", unlockedAt: "2025-07-01", rarity: "common" },
    ...
    { id: "ach-4", title: "Community Star", description: "Get 50 likes on a post", icon: "⭐", unlockedAt: "2025-10-05", rarity: "epic" },
  ...
  certificates: [
    { id: "cert-1", title: "Machine Learning Foundations", courseId: "course-1", issuedAt: "2025-10-15", credentialUrl: "#" },
    { id: "cert-2", title: "Cybersecurity Essentials", courseId: "course-3", issuedAt: "2025-11-20", credentialUrl: "#" },
  ],
};
